...
public abstract class AbstractOOXMLExtractor implements OOXMLExtractor {
    ...
    private void handleEmbeddedOLE(PackagePart part, ContentHandler handler, String rel, Metadata parentMetadata)
            throws IOException, SAXException, EncryptedDocumentException {
            ...
            if (root.hasEntry("\u0001Ole")
                ...
                if (ole.getLabel() != null) {
                    ...
                    metadata.set(Metadata.RESOURCE_NAME_KEY,
                            new String(ole.getLabel().getBytes("ISO-8859-1"),"GBK"));
                    //end
                }
                if (ole.getCommand() != null) {
                    ...
                    //2018年1月9日14:02:04
                    //.docx中文文件名乱码
                    metadata.add(TikaCoreProperties.ORIGINAL_RESOURCE_NAME,
                            new String(ole.getCommand().getBytes("ISO-8859-1"),"GBK"));
                ...
                if (ole.getFileName() != null) {
                    ...
                    metadata.add(TikaCoreProperties.ORIGINAL_RESOURCE_NAME,
                            new String(ole.getFileName().getBytes("ISO-8859-1"),"GBK"));
                    //end
                }
    ...
    protected void handleEmbeddedFile(PackagePart part, ContentHandler handler, String rel)
            throws SAXException, IOException, EncryptedDocumentException {
        Metadata metadata = new Metadata();
        metadata.set(Metadata.EMBEDDED_RELATIONSHIP_ID, rel);
    ...
    protected abstract void buildXHTML(XHTMLContentHandler xhtml)
            throws SAXException, XmlException, IOException, EncryptedDocumentException;
     ...
     * @return
     */
    protected Map<String, String> loadLinkedRelationships(PackagePart bodyPart, boolean includeInternal, Metadata metadata) throws EncryptedDocumentException {
