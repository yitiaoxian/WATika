...
public class SXWPFWordExtractorDecorator extends AbstractOOXMLExtractor {
    ...
    private void handleDocumentPart(PackagePart documentPart, XHTMLContentHandler xhtml) throws IOException, SAXException, EncryptedDocumentException {
    ...
    private void handlePart(PackagePart packagePart, XWPFStylesShim styles,
                            XWPFListManager listManager, XHTMLContentHandler xhtml) throws IOException, SAXException, EncryptedDocumentException {
