...
public class EmbeddedDocumentUtil implements Serializable {
    ...
    public static void recordEmbeddedStreamException(Throwable t, Metadata m) throws EncryptedDocumentException {
        String ex = ExceptionUtils.getFilteredStackTrace(t);
        /***
         * added by xiao
         * 第三次修改
         * 对记录在元数据的信息是否含有EncryptedDocumentException进行判断
         * 第四次修改还原第三次之前
         * */
        //if(ex.indexOf("EncryptedDocumentException")!=-1){
