            ...
            if (type == POIFSDocumentType.OLE10_NATIVE) {
                try {
                    ...
                    if (ole.getLabel() != null) {
                        ...
                        //藏文维文韩文仍然乱码
                        //.xls
                        metadata.set(Metadata.RESOURCE_NAME_KEY, rName + '/'
                    ...
                    if (ole.getFileName() != null) {
                        //****added by xiao
                        //2018年1月8日15:26:51
                        //System.out.println("before:"+ole.getFileName());
                        //String str = new String(ole.getFileName().getBytes("ISO-8859-1"),"gbk");
                        //System.out.println("gb18030:"+str);
                        //.xls
