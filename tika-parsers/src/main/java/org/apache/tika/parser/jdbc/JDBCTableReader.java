...
class JDBCTableReader {
    ...
    public boolean nextRow(ContentHandler handler, ParseContext context) throws IOException, SAXException, EncryptedDocumentException {
        //lazy initialization
        if (results == null) {
            reset();
        }
    ...
    private void handleCell(ResultSetMetaData rsmd, int i, ContentHandler handler, ParseContext context) throws SQLException, IOException, SAXException, EncryptedDocumentException {
    ...
    protected void handleClob(String tableName, String columnName, int rowNum,
                              ...
                              ContentHandler handler, ParseContext context) throws SQLException, IOException, SAXException, EncryptedDocumentException {
