...
public class SXSLFPowerPointExtractorDecorator extends AbstractOOXMLExtractor {
     ...
     */
    protected void buildXHTML(XHTMLContentHandler xhtml) throws SAXException, IOException, EncryptedDocumentException {
    ...
    private void handleSlidePart(PackagePart slidePart, XHTMLContentHandler xhtml) throws IOException, SAXException, EncryptedDocumentException {
